...
/****** Object:  Database [AutoShop]    Script Date: 02.04.2025 21:51:11 ******/
...
CREATE DATABASE [AutoShop]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'AutoShop', FILENAME = N'E:\MSSQL\MSSQL16.SQLEXPRESS\MSSQL\DATA\AutoShop.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'AutoShop_log', FILENAME = N'E:\MSSQL\MSSQL16.SQLEXPRESS\MSSQL\DATA\AutoShop_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [AutoShop] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [AutoShop] SET QUERY_STORE = ON
GO

ALTER DATABASE [AutoShop] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
